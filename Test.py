...
class ThearteSeats:
    def __init__(self):
        ...
        ThearteSeats.title('Title')
        ThearteSeats.option_add('*Font', 'Georgia 12')
        ThearteSeats.option_add('*background', 'grey20')
        ThearteSeats.option_add('*label.Font', 'helvetica 14')
        ThearteSeats.geometry('1200x540+100+100')
        ThearteSeats.configure(bg='grey20')

        DateSelectFrame = Frame(ThearteSeats)
...
# type of buy
        typeofticketframe = Frame(ThearteSeats, highlightthickness='1', highlightbackground='white')
...
# Ticket types
        TicketContainer = Frame(ThearteSeats, highlightthickness='1', highlightbackground='white')
...
# Seats-----------------------------------
        ...
        for i in range(10):
            for y in range(1, 21):
                ...
                count += 1
                #print(self.btn[count])


# Details --------------
        nameBox = Frame(ThearteSeats, highlightthickness='1', highlightbackground='white')
    ...
    #Getting data
        OutputWidgets = Frame(ThearteSeats, highlightthickness='1', highlightbackground='white')
        ...
        ButtonOutputWidgetFrame = Frame(ThearteSeats, highlightthickness='1', highlightbackground='white')
        ...
        ShowStatsButtonFrame = Frame(ThearteSeats, highlightthickness='1', highlightbackground='white')
    ...
    def infoGet(self):
        ...
        first = self.firstNameVar.get()
        if first.isalpha() and len(first) < 20:
            correctScore += 1
        else:
            print('First name not acceptable')

        second = self.secondNameVar.get()
        if second.isalpha() and len(second) < 20:
            correctScore += 1
        else:
        ...
        if correctScore != 3:
            ...
            self.customerDetails.append(first)
            self.customerDetails.append(second)
